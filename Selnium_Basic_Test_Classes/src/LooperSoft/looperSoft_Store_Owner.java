...
public class looperSoft_Store_Owner {
...
//		driver.findElement(By.xpath("//*[@id='select2-stateid-container']")).click();
		driver.findElement(By.xpath("//span[@id='select2-userid-container']")).click();
//		driver.findElement(By.xpath("//span[@class='select2-dropdown select2-dropdown--above']")).click();
		List<WebElement> list = driver.findElements(By.xpath("//ul[@id='select2-userid-results']//li"));
		...
		for(WebElement element:list){
			...
			if (element.getAttribute("innerHTML").contains("Alex (alexsuryaras@gmail.com)"))
			{
				element.click();
				System.out.println("Selected Store Owner is ====== "+innnerhtml);
				break;
			}
